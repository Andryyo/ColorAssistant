        ...
        <input type="file" id="fileInput" name="file" onChange={(e) => {
          ...
          <Button onClick={() => {
            ...
            if (cv) {
              ...
              const mat = cv.matFromImageData(ctx.getImageData(0, 0, canvas.widgth, canvas.height));
              ...
              imgData.data.set(new Uint8ClampedArray(newImage.data, newImage.cols, newImage.rows));
